...
class ImageSelectViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate, AdobeUXImageEditorViewControllerDelegate {
    ...
    @IBAction func handleLibraryButton(_ sender: AnyObject) {// ライブラリ（カメラロール）を指定してピッカーを開く
    ...
    @IBAction func handleCameraButton(_ sender: AnyObject) {// カメラを指定してピッカーを開く
    ...
    @IBAction func handleCancelButton(_ sender: AnyObject) {// 画面を閉じる
